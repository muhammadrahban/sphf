...
@section('contain')
    <div class="row page-titles" style="box-shadow: 0px 0px 14px 3px #cfcfcf; background: linear-gradient(45deg, rgb(241, 234, 234), transparent);border: 1px solid #cdcdcd;">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Offer Management</h3>
        </div>
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="{{route('offer.form')}}"><button type="button"
                        ...
                        @foreach ($offers as $offer)
                            <tr>
                                ...
                                <td class="text-canter">
                                    <a title="Edit" href="{{ route('offer.edit', $offer->id) }}"><i
                                            class="far fa-edit" style="font-size:20px"></i></a>

                                    <a title="Delete" type="button" onclick="swalll({{ $offer->id }})"><i class="fa fa-trash "
                                            aria-hidden="true"></i></a>
                                    <form id="delete-form-{{ $offer->id }}"
                                        action="{{ route('offer.delete', $offer->id) }}" method="POST" class="d-none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
