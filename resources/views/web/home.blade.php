                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h4 class="text-white mb-5">Join the Largest Housing Rehabilitation Program – 2.1 Million Resilient Houses Need Your Support</h4>
                ...
                <div class="col-lg-6">
                    <div class="row mt-5 mb-1">
                        <div class="col-md-6">
                            ...
                            <div class="custom-card orange p-4 text-right mb-4" style="width: 100%; min-height:200px; background-color: #df5311; height:90%;">
                                <!--<i class="fa-5x far fa-heart text-light"></i>-->
                                 </a><img  style="width: 70px; height: 70px;" src="{{asset('images/Home_icon/Icons-04.svg')}}">
                               <a href="/sphf/public/doner/register"> <h4 class="text-light text-left">Register</h4></a>
                                <a href="/sphf/public/doner/register"><p class="text-light text-left">Signing up as a donor is quick, easy, systematic and secure</p></a>
                            </div>  
                        </div>
                        <div class="col-md-6 ">
                        ...
                        <div class="col-md-6 ">
                            <div class="custom-card orange p-4 text-right mb-4" style="width: 100%; min-height:200px; background-color: #8139e7; height:90%;">
                                <!--<i class="fa-5x far fa-heart text-light"></i>-->
            ...
            <div class="container">
                ...
                <div class="box-slider-2 slider">
                    ...
                    <div class="slide" style="background-image: url('{{asset('images/home_adopt_beneficiary/Img_jamshoro.png')}}');">
                     ...
                     <!--22-->
                     <div class="slide" style="background-image: url('{{asset('images/home_adopt_beneficiary/Img_tharparkar.png')}}');">
                        <div class="overlay"></div>
                        <div class="cover p-4">
                            <label class="badge badge-warning text-white px-2 py-1 rounded-0" style="background-color: #df5311; font-size: 15px">THARPARKAR</label>
        ...
        <section>
            <div class="container" id="DdSPHF">
                <div class="row mx-0 my-5">
                            ...
                            <div style="margin-top: 20%;">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <button type="button" class="form_price_btn">Rs 600,000</button>
                                        <button type="button" class="form_price_btn">Rs 900,000</button>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <a href="{{route('becom.doner')}}" type="button" class="form_submit_btn">DONATE</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="col-md-6 order-1 order-md-2 p-0 form-cover" style="background-image: url('{{asset('images/Transfer-you-donation-overlay-02.jpg')}}');">
                        <div class="overlay"></div>
                    ...
                    <div class="col-lg-4 col-md-12 mb-4">
                        <div class="h-100" style="position:relative; background-image:url('{{asset('images/our_donor/make_a_difference.jpg')}}'); background-size: cover; background-position: center;">
                            ...
                            <div class="p-5" style="position: relative;">
                                ...
                                <img  style="width: 70px; height: 70px;" src="{{asset('images/Home_icon/Icons-03.svg')}}">
