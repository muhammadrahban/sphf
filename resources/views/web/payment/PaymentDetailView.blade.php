                ...
                <div class="col-md-8 offset-2">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="bank_list">Select Bank: <span
                                                        class="text-danger">*</span></label>
                                                <input type="number" id="bank_list" class="form-control" max="16">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                    ...
                    <div>
                        ...
                        <div class="py-4 d-flex justify-content-between">
                            ...
                            <a href="#" class="text-success">Edit Donation &nbsp;&nbsp; <i class="fa fa-pencil-square" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                    <table class="table table-bordered checkout-list">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="text-secondary m-0 text-center" style="font-size: 18px;">PKR 1,500,000
                                    </p>
                                </td>
                            </tr>
                        </tbody>
