...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('images/emoji.png') }}">
    <title>Free Digital</title>
...
<body class="skin-default card-no-border">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Free Digital</p>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <section id="wrapper" class="login-register login-sidebar"
        ...
        <div class="login-register" style="background-color: #68bbbe;">
            <div class="col-md-9">
                <div class="d-flex flex-column justify-content-end" style="background-image: url('{{ asset('images/freedigiBackground.png') }}'); background-position: center;background-repeat: repeat;height: 100vh; ">
                ...
                <div class="card-body d-flex flex-column justify-content-center">
                    <form method="POST" class="form-horizontal form-material" id="loginform" action="{{ route('login') }}">
                        ...
                        <div class="d-flex justify-content-center" style="width: 100%; height: auto; padding: 5px 0px; margin-bottom: 31%;">
                            <img src="{{ asset('images/freedigitalNewLogo.png') }}" alt="" style="width: 400px; height: 20vh; filter: grayscale(100%);">
                        </div>
                        ...
                        <div class="form-group text-center d-flex justify-content-center" style="margin-top: 2%;">
                            <button class="btn btn-lg btn-rounded text-white"
                                style="background-color: rgb(190 156 24); width: 35%; margin-top: 7%; filter: grayscale(100%);"
