                ...
                <div class="navbar-header">
                    {{-- <a class="navbar-brand text-center" href="index.html"> --}}
                        ...
                        <b>
                            ...
                            <!-- Light Logo icon -->
                            {{-- <img src="{{asset('images/freedigitalNewLogo.png')}}" alt="homepage" class="light-logo" style="width: 118px;"/> --}}
                            <img src="{{ asset('images/freedigitalNewLogo.png') }}" alt="homepage" class="light-logo" style="width: 118px; filter: grayscale(100%);"/>
